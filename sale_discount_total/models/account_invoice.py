        ...
        for inv in self:
            if inv.discount_type == 'percent':
                ...
                for line in inv.invoice_line_ids:
                    total += line.tax_ids.compute_all(line.price_unit, line.move_id.currency_id, line.quantity,
                                                      product=line.product_id,
                                                      partner=line.move_id.partner_shipping_id)['total_excluded']
                if inv.discount_rate != 0 and total:
